...
<base href="<%=basePath%>">
<link href="${pageContext.request.contextPath}/demo/main/resources/css/main.css" rel="stylesheet" type="text/css" />
<%@ include file="/common/easyui.jsp"%>
<script type="text/javascript" src="${pageContext.request.contextPath}/demo/main/resources/js/main.js"></script>
</head>
